...
import { Shield, DollarSign, CheckCircle, Clock, Star, Zap, Trophy, Target } from 'lucide-react-native';
    ...
    >
      ...
      <View style={styles.header}>
        <View style={styles.categorySection}>
          <View style={[
            styles.categoryIcon,
            quiz.category === "fraud" ? styles.fraudIcon : styles.financialIcon
          ]}>
          ...
          <View style={[
            ...
            <Text style={[
              styles.categoryText,
              quiz.category === "fraud" ? styles.fraudText : styles.financialText
            ]}>
